...
def printhelp():
        print
        print "WikiMung revision 09 Jul 2014"
        ...
        print "-o: The base name of the output file. Defaults to \"bundle\"."
...
try:
        ...
        root.set("xmlns", "http://www.mediawiki.org/xml/export-0.8/")
        ...
        for link in pagelist:
                ...
                title.text = str(sql.fetchall()[0][0]).decode('utf-8')
                if verbose:
                ...
                while nextrev != 0:
                        ...
                        username.text = str(sql.fetchall()[0][0]).decode('utf-8')
                        ...
                        if rawcomment:
                                ...
                                comment.text = str(rawcomment[0][0]).decode('utf-8')
                        ...
                        if rawlen:
                                ...
                                text.text = str(sql.fetchall()[0][0]).decode('utf-8')
